    ...
    return (
        <div className="p-4 md:w-1/3" data-aos="zoom-out-right">
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">BLOG</h2>
                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{name}</h1>
                    <p className="mb-3 truncate" style={{ width: '300px' }}>{description}</p>
                    <div className="flex items-center flex-wrap ">
                        <Link to={`/post/${_id}`} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Read More
